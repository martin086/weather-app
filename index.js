...
search.addEventListener('click', ()=> {
    const API_KEY = '747ae8e97d9fd273a6d28a71a969d885';
    const lang = 'es';
    ...
    if (city === '')
        ...
        .then(json => {
            ...
            const feeling = document.querySelector('.weather-box .feeling');
            ...
            feeling.innerHTML = `<span>ST: </span>${parseInt(json.main.feels_like)}<span>°C</span>`;
